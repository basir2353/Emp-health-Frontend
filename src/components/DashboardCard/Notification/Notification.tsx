  ...
  return (
    <div className="flex justify-center items-center ">
      <div className="text-center mt-10">
        ...
        <div className="bg-white w-[706px] h-[807px] p-2 mt-4">
          <div className=" w-[690px] h-[104px] p-2 mt-4 rounded-md border-2 shadow-md flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-12 items-center">
                ...
                <div className="w-[383px] text-left font-normal text-black">
                  A request is made by Angela Smith to subscribe to an insurance
                  plan.
                </div>
              </div>
            </div>
...
<path d="M20 16.3145V20.9145" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M19.9948 23.8105H20.0033" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

                </div>

                <div className="w-[383px] text-left font-normal text-black">
                A report has been generated from with in your team with report number #09892. Please investigate this.
                </div>
              </div>
            </div>
            <div className="flex flex-col items-end gap-2 ">
