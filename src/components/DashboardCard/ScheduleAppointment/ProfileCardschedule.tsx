  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      ...
      try {
        ...
        setAppointments(response.data.appointments); // assuming the response structure
      } catch (err: any) {
        ...
        appointments.map((appointment, index) => (
          ...
          >
            <div className="flex items-center p-5">
              ...
              <div className="flex flex-col items-start">
                <h3 className="text-lg font-bold text-black">
                  ...
                  <span className="font-normal text-base"> Doctor</span>
                </h3>
            ...
            <button
              ...
              className="flex items-center justify-center ml-5 gap-10 w-[112px] h-[24px] bg-white border border-gray-300 rounded shadow"
            >
              View schedule
            </button>
          </div>
