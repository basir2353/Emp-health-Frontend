...
// Declare wellnessMenuItems so it's accessible in all blocks
let wellnessMenuItems: MenuProps["items"] = [];

// Add regular menu items for non-admin and non-doctor users
...
// Add ONLY admin-specific items if user is admin
if (userRole === "admin") {
  wellnessMenuItems = [
    {
