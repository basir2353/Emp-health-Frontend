...
export const verifyOTP = async (data) => {
  const response = await axios.post(`http://empolyee-backedn.onrender.com/api/auth/verify-otp`, data);
  return response.data;
};
...
export const loginUser = async ({ email, password }) => {
  const response = await axios.post(`http://empolyee-backedn.onrender.com/api/auth/login`, {
    email,
    password,
  });
