...
export const getOnlineUsers = async () => {
  try {
    ...
    const response = await callApi.get('http://empolyee-backedn.onrender.com/api/auth/online-users');
...
export const getOnlineDoctors = async () => {
  try {
    ...
    const response = await callApi.get('http://empolyee-backedn.onrender.com/api/auth/online-doctors');
...
export const getAllDoctors = async () => {
  try {
    ...
    const response = await callApi.get('http://empolyee-backedn.onrender.com/api/all-doctors');
...
export const getAllAppointments = async () => {
  try {
    ...
    const response = await callApi.get('http://empolyee-backedn.onrender.com/api/appointments');
...
export const getUserAppointments = async (userId) => {
  try {
    ...
    const response = await callApi.get(`http://empolyee-backedn.onrender.com/api/appointments/user/${userId}`);
...
export const getDoctorAppointments = async (doctorId) => {
  try {
    ...
    const response = await callApi.get(`http://empolyee-backedn.onrender.com/api/appointments/doctor/${doctorId}`);
