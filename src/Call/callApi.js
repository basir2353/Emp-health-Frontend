...
const API_BASE_URL = 'https://empolyee-backedn.onrender.com/api/auth';

// Create axios instance with default config
const callApi = axios.create({
  baseURL: 'https://empolyee-backedn.onrender.com/api/auth',
  timeout: 10000,
});
...
export const getOnlineDoctors = async () => {
  try {
    const response = await axios.get('https://empolyee-backedn.onrender.com/api/auth/online-doctors');
    return response.data;
  } catch (error) {
